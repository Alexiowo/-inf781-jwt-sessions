...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.setRefreshCookie = function (res, token) {
        ...
        AuthController_1.prototype.register = function (dto, req, res) {
            return __awaiter(this, void 0, void 0, function () {
                var p;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.auth.register(dto, req.headers['user-agent'])];
                        case 1:
                            p = _a.sent();
                            this.setRefreshCookie(res, p.refreshToken);
                            return [2 /*return*/, { accessToken: p.accessToken }];
                    }
                });
            });
        };
        AuthController_1.prototype.login = function (dto, req, res) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.auth.login(dto, req.headers['user-agent'])];
                        case 1:
                            p = _a.sent();
                            this.setRefreshCookie(res, p.refreshToken);
                            return [2 /*return*/, { accessToken: p.accessToken }];
        ...
        AuthController_1.prototype.refresh = function (u, req, res) {
            return __awaiter(this, void 0, void 0, function () {
                var p;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.auth.refreshTokens(u.sub, u.email, u.sessionId, u.refreshToken, req.header['user-agent'])];
                        case 1:
                            p = _a.sent();
                            this.setRefreshCookie(res, p.refreshToken);
                            return [2 /*return*/, { accessToken: p.accessToken }];
        ...
        AuthController_1.prototype.logout = function (sessionId, res) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.auth.logout(sessionId)];
                        case 1:
                            _a.sent();
                            res.clearCookie('refreshToken', { path: '/auth' });
                            return [2 /*return*/, { message: 'Sesión cerrada' }];
                    }
                });
            });
        };
        ...
        AuthController_1.prototype.sessions = function (userId) {
    ...
    (function () {
        ...
        _refresh_decorators = [(0, common_1.UseGuards)(refresh_token_guard_1.RefreshTokenGuard), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, common_1.Post)('refresh')];
        _logout_decorators = [(0, common_1.UseGuards)(refresh_token_guard_1.RefreshTokenGuard), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, common_1.Post)('logout')];
        _me_decorators = [(0, common_1.UseGuards)(access_token_guard_1.AccessTokenGuard), (0, common_1.Get)('me')];
        _sessions_decorators = [(0, common_1.UseGuards)(access_token_guard_1.AccessTokenGuard), (0, common_1.Get)('sessions')];
        ...
        __esDecorate(_classThis, null, _sessions_decorators, { kind: "method", name: "sessions", static: false, private: false, access: { has: function (obj) { return "sessions" in obj; }, get: function (obj) { return obj.sessions; } }, metadata: _metadata }, null, _instanceExtraInitializers);
